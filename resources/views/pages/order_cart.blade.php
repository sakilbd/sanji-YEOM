                            ...
                            <tr>
                                <td>
                                    <figure class="itemside align-items-center">
                                        <div class="aside"><img src={{ asset($order->itemInfo['item_image_url']) }} class="img-sm" style="width:50%;height:40px"></div>
                                        <figcaption class="info"> <a href="#" class="title text-dark" data-abc="true"><b>{{ $order->itemInfo['name'] }}</b></a>
                                ...
                                @endphp
                                <td>
                                    <div class="price-wrap"> <var  class="price">$<span id={{ $order->id.'price' }}>{{ $itemPrice }}</span></var>&nbsp<small class='text-muted'>${{ $order->itemInfo['price'] }} &nbsp each</small></div>
                                </td>
